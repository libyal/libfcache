...
$LibraryTests = "cache cache_value date_time error support"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\fcache_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libfcache"
